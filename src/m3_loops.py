...
def run_test_practice_problem3():
    ...
    # Test 15:
    test15 = practice_problem3(5, 3, 1.2)
    expected15 = [7, 13, 20]
    print()
    print('Test 15:')
    ...
    # Test 16:
    test16 = practice_problem3(1000, 5, .5)
    expected16 = [1000, 1001, 1005, 1006, 1007]
    print()
    print('Test 16:')
...
def practice_problem3(start, n, threshold):
    ...
    incrementing_num = start
    new_list = []
    if n == 0:
        return new_list
    while True:
        if math.sin(incrementing_num) + math.cos(incrementing_num) > threshold:
            new_list = new_list + [incrementing_num]
        if len(new_list) == n:
            break
        incrementing_num = incrementing_num + 1
    return new_list
